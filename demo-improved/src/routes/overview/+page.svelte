...
<div class="container mx-auto p-4">
  <h1 class="text-3xl font-bold mb-6 text-orange-600 text-center">
    Svelte Summit Conference Tasks
  </h1>

  {#await data.users}
    <div class="flex justify-center items-center py-12">
      <div
        class="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-orange-600"
      ></div>
      <span class="ml-4 text-lg text-gray-600 animate-pulse"
        >Loading conference tasks...</span
      >
    </div>
  {:then users}
      ...
      {#each users as user, index}
        ...
        >
          ...
          <div class="mb-4">
            ...
            >
              {user.todos.length} conference tasks
            </span>
          </div>
